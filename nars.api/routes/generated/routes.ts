...
const models: TsoaRoute.Models = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Pick_Member.email-or-name-or-phoneNumbers_": {
        "dataType": "refAlias",
    ...
    "MemberCreationParams": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_Member.email-or-name-or-phoneNumbers_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
};
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsMembersController_getMember: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.get('/api/members/:memberId',
            ...
            async function MembersController_getMember(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsMembersController_getMember, request, response });
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsMembersController_createMember: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.post('/api/members/create',
            ...
            async function MembersController_createMember(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsMembersController_createMember, request, response });
